...
namespace Thimble
{
    [AddComponentMenu("Scripts/Thimble/Variable Storage Referencer")]
    public class VariableStorageReferencer : MonoBehaviour
    {
        ...
        /// </summary>
        /// <remarks>
        /// This method attempts to retrieve the variable storage from the associated component and ensures that all defined variables are properly linked to the storage. 
        /// It also retrieves the current values of the variables from the storage after the association.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>This method iterates through all variables in the collection, if any exist,  and sets their storage to <see langword="null"/> before clearing their data.</remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This method extracts initial variable values from a Yarn project and organizes them into separate dictionaries based on their types: float, string, and bool. 
        /// These dictionaries can be used to initialize or reset the state of a dialogue system.
        /// </remarks>
        /// <returns>
        /// A tuple containing three dictionaries:  
        /// <list type="bullet"> 
        /// <item> <description>A dictionary of float variables, keyed by variable name.</description> </item> 
        /// <item> <description>A dictionary of string variables, keyed by variable name.</description> </item> 
        /// <item> <description>A dictionary of bool variables, keyed by variable name.</description> </item> 
        /// </list>
        /// </returns>
        private (Dictionary<string, float> floats, Dictionary<string, string> strings, Dictionary<string, bool> bools) GetInitialValues()
        {
            ...
            foreach (var pair in values)
            {
                ...
                switch (value)
                {
                    // Add the string variable to the dictionary
                    case string stringValue:
                        stringVariables.Add(pair.Key, stringValue);
                        break;
                    // Add the float variable to the dictionary
                    case float floatValue:
                        floatVariables.Add(pair.Key, floatValue);
                        break;
                    // Add the bool variable to the dictionary
                    case bool boolValue:
