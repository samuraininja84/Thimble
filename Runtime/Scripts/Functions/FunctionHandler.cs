...
namespace Thimble
{
    public static class FunctionHandler
    {
        ...
        public static void AddFunction(this FunctionData functionData, Function function, DialogueRunner runner = null)
        {
            // Set the runner if it is not already set
            functionData.Register(runner);

            // Add the function
            functionData.AddFunction(function);
        }

        public static void RemoveFunction(this FunctionData functionData, Function function, DialogueRunner runner = null)
        {
            // Set the runner if it is not already set
            functionData.Register(runner);
        ...
        public static void RemoveFunction(this FunctionData functionData, string functionName, DialogueRunner runner = null)
        {
            // Set the runner if it is not already set
            functionData.Register(runner);
        ...
        public static void ActivateFunction(this FunctionData functionData, Function function, DialogueRunner runner = null)
        {
            // Set the runner if it is not already set
            functionData.Register(runner);
        ...
        public static void DeactivateFunction(this FunctionData functionData, Function function, DialogueRunner runner = null)
        {
            // Set the runner if it is not already set
            functionData.Register(runner);
