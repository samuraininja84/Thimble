...
namespace Thimble
{
    ...
    public class Command : IRegisterCommands
    {
        ...
        public string GetCommandInfo() => $"Command Tier: {CommandTierToString()}\nCommand Origin: {commandOrigin}\nCommand Name: {commandName}\nCommand Description: {commandDescription}\nCommand Syntax: {commandSyntax}";

        public string CommandTierToString() => commandTier.ToString().Insert(4, " ");

        public bool CommandActive() => commandState == CommandState.Active;
