...
namespace Thimble.Editor
{
    ...
    public class StringVariablePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var nameProperty = property.FindPropertyRelative(nameof(StringVariable.Name).ToLower());

            // Get the value property and set it to lowercase to match the serialized field name
            var valueProperty = property.FindPropertyRelative(nameof(StringVariable.Value).ToLower());
            ...
            EditorVariableExtensions.DrawVariableSelector(nameRect, nameProperty, valueProperty, VariableType.String);
